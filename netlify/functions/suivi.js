...
const PROP = {
  ...
  dinnerSrc:   { name: "Dîner source",        type: "select" },
  dessert:     { name: "Dessert midi",        type: "checkbox" },
  dessertQuand:{ name: "Dessert quand",       type: "select" },
  velo:        { name: "Vélo",                type: "checkbox" },
  velotaff:    { name: "Vélo taff",           type: "checkbox" },
  velosortie:  { name: "Vélo sortie",         type: "checkbox" },
...
function pageToFields(page) {
  ...
  return {
    ...
    dinnerSrc:   sel(PROP.dinnerSrc.name),
    dessert:     chk(PROP.dessert.name),
    dessertQuand:sel(PROP.dessertQuand.name),
    velo:        chk(PROP.velo.name),
    velotaff:    chk(PROP.velotaff.name),
    velosortie:  chk(PROP.velosortie.name),
